...
import { ArrowLeft, Trophy, Calendar, Clock, CheckCircle } from "lucide-react";
    ...
    <div className="px-4 pt-6 pb-24 max-w-md mx-auto">
      ...
      <div className="grid grid-cols-2 gap-3 mb-6">
        {outcomeData.map(({ label, count, icon: Icon, color, textColor }) => (
          <div
            key={label}
            className="bg-card border border-border rounded-2xl p-4 flex flex-col items-start gap-2 animate-fade-in"
          >
